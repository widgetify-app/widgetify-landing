		...
		<ContainerWrapper>
			...
			<div className="relative py-20 text-white bg-gradient-to-br from-blue-600 to-purple-700">
				...
				<div className="flex flex-col items-center text-center">
					<h1 className="mb-6 text-4xl font-bold md:text-5xl lg:text-6xl">
						<span className="block">ویجتیفای</span>
					...
					<p className="max-w-2xl mb-12 text-lg text-blue-100 md:text-xl">
						با ویجتیفای، اطلاعات مورد نیاز خود را در قالب ویجت‌های زیبا و کاربردی در
					...
					<div className="relative w-full max-w-4xl mx-auto mt-8">
						<div className="overflow-hidden bg-white rounded-lg shadow-2xl aspect-video">
							<img
								...
								onError={(e) => {
									e.currentTarget.src = 'https://placehold.co/1200x675?text=ویجتیفای'
								}}
							/>
						</div>
			...
			<div className="py-8">
				<h2 className="mb-12 text-3xl font-bold text-center">
					در هر پلتفرمی که هستید، ویجتیفای همراه شماست
				</h2>
			...
			<div className="p-8 text-center text-white bg-gradient-to-br from-blue-600 to-purple-700 rounded-xl">
				<h2 className="mb-4 text-2xl font-bold">
					با ویجتیفای، همه چیز را در یک نگاه ببینید
				</h2>
				<p className="mb-6 text-blue-100">
					همین حالا نسخه مورد نظر خود را انتخاب کرده و از ویجتیفای استفاده کنید
				</p>
